...
public class ProductController {
    ...
    public void deleteProduct(@PathVariable("productId") Long productId, @RequestParam("deletedBy") String deletedBy) {
        productService.deleteProduct(productId, deletedBy);
    }

    @GetMapping("/{id}/reduceQuantity")
    public void reduceProductQuantity(@PathVariable("id") Long id, @RequestParam("quantity") int quantity) {
